...
public class RobotContainer {
  ...
  private RobotContainer() {
    ...
    SmartDashboard.putData("AutoBalance", new AutoBalance(m_driveSubsystem));
  ...
  private void configureButtonBindings() {
    ...
    // Create some buttons
    final JoystickButton button4DriveAutoBalance = new JoystickButton(driveJoystick, 4);
    button4DriveAutoBalance
        .whileTrue(new AutoBalance(m_driveSubsystem).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
    SmartDashboard.putData("button4DriveAutoBalance", new AutoBalance(m_driveSubsystem));
