...
// Create some buttons
final JoystickButton btnAtuoBalance = new JoystickButton(driveJoystick, 4);        
btnAtuoBalance.whileTrue(new AutoBalance( m_driveSubsystem ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
