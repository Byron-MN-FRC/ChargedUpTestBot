...
private final Joystick driveJoystick = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Autonomous Command", new AutonomousCommand());    SmartDashboard.putData("driveLift", new driveLift( m_lift ));
...
button2intake.whileTrue(new Intake( m_intakeSubsystem ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
                        
final JoystickButton bttnToggleClaw = new JoystickButton(driveJoystick, 1);        
bttnToggleClaw.onTrue(new ToggleClaw( m_claw ).withInterruptBehavior(InterruptionBehavior.kCancelSelf));
