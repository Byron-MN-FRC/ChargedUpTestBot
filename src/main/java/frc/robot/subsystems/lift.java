...
armExtender = new DoubleSolenoid(9, PneumaticsModuleType.CTREPCM, 7, 6);
 addChild("armExtender", armExtender);
    ...
    public void periodic() {
       ...
       if (armExtender.get() == Value.kForward)
            SmartDashboard.putString ("status","silinoidextended");
        else 
            SmartDashboard.putString ("status","notextended");
