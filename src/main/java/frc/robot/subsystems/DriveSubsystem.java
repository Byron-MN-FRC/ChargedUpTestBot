...
private DifferentialDrive driveSubsystem;
...
driveSubsystem = new DifferentialDrive(rightMaster, leftMaster);
 addChild("DriveSubsystem",driveSubsystem);
...
pigeon = new PigeonIMU(4);
    ...
    public void setMaxOutput(double maxOutput) {
        driveSubsystem.setMaxOutput(maxOutput);
    }
